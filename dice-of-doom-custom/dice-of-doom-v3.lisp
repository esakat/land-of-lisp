...
;; > svg.lisp : 原書で17章に出てくるsvgマクロにはwidth, height引数が無くて、19章で使うsvgマクロにはこれらの引数がついてる。原書の指示どおり17章のコードをセーブして19章でロードして使おうとするとエラーになる。ダウンロード可能なコードでは、19章のdice_of_doom_v3.lispでsvgマクロをあらためて定義している。訳書はsvgマクロのインタフェースを19章のものに統一してある。 
...
(defun dod-request-handler (path header params)
  (if (equal path "game.html")
      (progn 
			  ;; 以下３行を追加 -- https://lambdacadabra.blogspot.com/2016/11/land-of-lispwebfirefox.html
